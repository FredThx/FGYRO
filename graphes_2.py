...
mybdd = gyro_db(host = 'localhost', topic = 'FILEUROPE/GYRO/2', date_debut = datetime.datetime(2018,7,1,11,00), date_fin = datetime.datetime(2018,12,31,23,59))# datetime.datetime(2017,3,24,23,00))
