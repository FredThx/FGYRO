...
class gyro_db(object):
	...
	'''
	def __init__(self, connect_string = None, host = '127.0.0.1', port = 27017, db_name = 'fileurope', topic = 'FILEUROPE/GYRO/1', date_debut = None, date_fin = None, TIMEZONE = 'Europe/Paris'):
		'''Initialisation
			- host				:	mongodb host (default : localhost)
			- port				:	mongodb port (default : 27017)
			- db_name			:	database name (default : 'fileurope')
			- topic				:	name of the remutraceur
			- date_debut
			- date_fin
		'''
		if connect_string:
